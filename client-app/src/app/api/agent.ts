...
import { IActivitiesEnvelope, IActivity } from '../models/activities';
import { history } from "../..";
...
axios.interceptors.response.use(undefined, error => {
    ...
    if (status === 500) {
        console.log("you should see toast")
...
const Profiles = {
    ...
    updateProfile: (profile: IProfile) => requests.put(`/profiles/${profile.username}`, profile),
...
const agentExport = { Activities, User, Profiles };
